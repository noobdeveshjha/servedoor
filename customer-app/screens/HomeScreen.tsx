...
export default function HomeScreen({ navigation }: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput style={styles.search} placeholder="Search restaurants..." value={search} onChangeText={setSearch} />
...
const styles = StyleSheet.create({ container: { flex: 1, padding: 16 }, header: { fontSize: 28, fontWeight: 'bold' }, search: { backgroundColor: '#f1f1f1', padding: 12, borderRadius: 10, marginVertical: 12 }, filterRow: { flexDirection: 'row', gap: 10, marginBottom: 16 }, filterBtn: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: '#eee', borderRadius: 20 }, activeFilter: { backgroundColor: '#f97316' }, card: { marginBottom: 16, borderRadius: 12, overflow: 'hidden', backgroundColor: '#fff', elevation: 3 }, image: { width: '100%', height: 160 }, info: { padding: 12 }, name: { fontSize: 18, fontWeight: 'bold' } });
